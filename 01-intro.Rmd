...
```{r spkr, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='speakers', out.width='200%', fig.asp=.75, fig.align='left'}
...
kable(spkrs, format = "html", escape = F, caption = "Guest speakers and local trials.", booktabs = TRUE) %>%
  kable_paper() %>% 
...
```{r forms, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Forms Criteria', out.width='200%', fig.asp=.75, fig.align='left'}
...
kable(forms, format = "html", escape = F, caption = "Forms Options.", booktabs = TRUE) %>%
  ...
  column_spec(3, width_min = "10cm", bold = F, italic = F) %>%
  column_spec(3, width_max = "10cm", bold = F, italic = F) %>%
  scroll_box(width = "900px", height = "1300px")
...
```{r data, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Data Interface Criteria', out.width='200%', fig.asp=.75, fig.align='left'}
...
```{r photo, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Data Interface Criteria', out.width='200%', fig.asp=.75, fig.align='left'}

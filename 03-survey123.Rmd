...
# kbl(form_ops,  caption = 'Survey123 Forms Options',align = "lllllcc",
...
kable(form_ops, format = "html", escape = F) %>%
  #kable_styling() %>%
  kable_paper() %>% 
  # column_spec(1, width_max = "1cm", bold = TRUE, italic = TRUE) %>%
  column_spec(2, width_max = "1cm", bold = TRUE, italic = TRUE) %>%
  #column_spec(3:5, width_max = "2cm", bold = TRUE, italic = TRUE) %>%
  column_spec(3:5, width_min = "2cm", bold = TRUE, italic = TRUE) %>%
  column_spec(5, width_min = "2.5cm", bold = TRUE, italic = TRUE) %>%

  #scroll_box(width = "1200px", height = "500px")
  scroll_box(width = "180%", height = "1000px")

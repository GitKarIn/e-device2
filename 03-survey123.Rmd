...
kable(survey123$Forms_Options,longtable = T, 
      booktabs  = T,  caption = ' Survey123 Forms Options') %>%
  add_header_above(c("Forms Options" = 3, " "= 4)) %>%
  kable_styling(latex_options = "repeat_header",full_width = F)
  
  
  # kable_styling(options = c("repeat_header"),full_width = F,
  # repeat_header_continued = "\\textit{(Continued on Next Page...)}")

```

```{r test, echo = FALSE, include=TRUE,  message=FALSE, warning=FALSE  }

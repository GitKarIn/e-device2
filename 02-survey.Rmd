...
```{r surv2, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Most common e-device software applications used by the IEP members who responded to the e-device survey.', out.width='100%', fig.asp=.75, tab.align='left'}
...
kable(popap_in, format = "html", escape = F, caption = 'Most common e-device software applications used by the IEP members who responded to the e-device survey.', booktabs = TRUE, align='l') %>%
   kable_paper() %>% 

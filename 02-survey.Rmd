...
```{r surv2, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Most common e-device software applications used by the IEP members who responded to the e-device survey.', out.width='80%', fig.asp=.75, fig.align='center'}


library(kableExtra)

popap_in <- readRDS("popapps.rds")

kable(popap_in, 
    escape = FALSE,
    format = "html",
    caption = 'Most common e-device software applications used by the IEP members who responded to the e-device survey.', booktabs = TRUE)

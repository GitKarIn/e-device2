...
```{r s123form, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Data Interface Criteria', out.width='70%', tab.asp=.75, tab.align='left' }
...
kable(s123form, format = "html", escape = F, caption = 'Data Interface Criteria',
  ...
  column_spec(1, width_min = "2cm", bold = TRUE) %>%
...
```{r s123dat, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Data Interface Criteria', out.width='100%', tab.asp=.75, tab.align='left' }
...
kable(s123dat, format = "html", escape = F, caption = 'Data Interface Criteria',
      col.names = c("Category","Feature"	,"Available","Description",		"Group Notes","External  Reviews","Score(0-3)"),
...
```{r s123phot, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Photo Integration and External Sensors', out.width='100%', tab.asp=.75, tab.align='left' }
...
```{r s123hard, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Data Interface Criteria', out.width='100%', tab.asp=.75, tab.align='left' }
...
kable(s123hard, format = "html", escape = F, caption = 'Data Interface Criteria',
      col.names = c("Feature"	,"Available",	"Group Notes"),
      booktabs = TRUE, align =  "l") %>%
  kable_paper() %>% 
  kable_styling(full_width =FALSE, fixed_thead = TRUE, font_size = 18) %>%
  
  column_spec(1, width_min = "8cm", bold = TRUE, italic = F) %>%
  column_spec(1, width_max = "8.5cm", bold = TRUE, italic = F) %>%
  column_spec(2, width_min = "3cm" ) %>%
  
  column_spec(3, width_min = "5.5cm") %>%
  column_spec(3, width_max = "6cm") %>%
  # column_spec(4, width_min = "4.5cm") %>%
  # column_spec(4, width_max = "5cm") %>%
...
```{r s123sec, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Data Interface Criteria', out.width='100%', tab.asp=.75, tab.align='left' }

library(kableExtra)

s123sec[] <- lapply(s123sec, function(x) ifelse(is.na(x), "", x))

kable(s123sec, format = "html", escape = F, caption = 'Data Interface Criteria', booktabs = TRUE, align =  "l",col.names = c("Feature"	,"Available",	"Description","Group Notes","External  Reviews","Score(0-3)")) %>%
  kable_paper() %>% 
  kable_styling(full_width =FALSE, fixed_thead = TRUE, font_size = 18) %>%
...
```{r #s123bus, echo = FALSE, include=TRUE, message=FALSE, warning=FALSE,  tab.cap='Data Interface Criteria', out.width='100%', tab.asp=.75, tab.align='left' }
...
s123bus %>%
  group_by(Feature) %>%
  mutate(Feature = ifelse(duplicated(Feature), "", Feature))  %>%
kable(s123bus, format = "html", escape = F, caption = 'Data Interface Criteria',  booktabs = TRUE,col.names = c("Feature"	,"Available",	"Description","Group Notes","External  Reviews","Score(0-3)"), align =  "l") %>%
  kable_paper() %>% 
  kable_styling(full_width =TRUE, fixed_thead = TRUE, font_size = 18) %>%
  
  column_spec(1, width_min = "4.0cm", bold = TRUE) %>%
  column_spec(1, width_max = "4.5cm", bold = TRUE) %>%
  column_spec(2, width_min = "5cm" ) %>%
  column_spec(3, width_min = "3.5cm") %>%
  column_spec(3, width_max = "4cm") %>%
  column_spec(4, width_min = "3cm") %>%
  column_spec(4, width_max = "3.5cm") %>%
  column_spec(5, width_min = "3.5cm") %>%
  column_spec(5, width_max = "4cm") %>%
  column_spec(6, width_min = "2cm") %>%
  scroll_box(width = "800px") 

...
```{r nmea, echo=FALSE,  out.width= "70%", fig.align='center',fig.cap="This picture shows how the scientists laptop can plug into the system without getting in the way of the captains station."}
